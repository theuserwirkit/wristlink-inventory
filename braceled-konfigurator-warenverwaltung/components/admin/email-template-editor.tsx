...
const PLACEHOLDER_HINT =
  "Platzhalter: {{kunde_anrede}}, {{anfrage_id}}, {{kunde_email}}, {{kunde_name}}, {{menge}}, {{event_datum}}, {{lieferort}}, {{angebot_netto}}, {{angebot_brutto}}, {{zahlungslink}}, {{zahlungslink_block}}, {{status_url}}, {{angebot_url}}, {{tracking_nr}}, {{versand_dienstleister}}, {{tracking_info}}, {{ablehnungsgrund}}, {{zahlungsnotiz}} — Kundenkommentare werden beim Versand automatisch eingefügt."
