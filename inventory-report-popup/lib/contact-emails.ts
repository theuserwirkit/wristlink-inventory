...
export const EMAIL_KONFIGURATOR = "angebote@braceled-led-armband.com"
export const RESEND_FROM_DEFAULT = `BraceLED <${EMAIL_KONFIGURATOR}>`
export const EMAIL_TESTMODE_DEFAULT = "test@braceled-led-armband.com"
