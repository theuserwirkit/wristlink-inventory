...
const PLACEHOLDER_HINT =
  "Platzhalter: {{anfrage_id}}, {{kunde_email}}, {{kunde_name}}, {{angebot_netto}}, {{angebot_brutto}}, {{zahlungslink}}, {{angebot_url}}, {{tracking_nr}}, {{kommentar}}, {{ablehnungsgrund}}, {{zahlungsnotiz}}"
