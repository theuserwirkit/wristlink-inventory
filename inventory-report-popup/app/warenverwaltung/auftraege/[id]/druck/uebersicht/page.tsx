...
export default async function PackingOverviewPrintPage({ params, searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <QuotePackingPrintView variant="overview" data={data} autoprint={autoprint === "1"} />
    </div>
  )
}
